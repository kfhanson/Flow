          ...
          >
            ...
            <div className="mt-auto pt-6">
              <button
                ...
                className="w-full rounded-2xl border border-brand-red/60 bg-brand-red-soft/40 px-4 py-3 text-sm font-semibold text-text-primary transition-colors hover:border-brand-red hover:bg-brand-red focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-red"
              >
                Add to cart
              </button>
            </div>
